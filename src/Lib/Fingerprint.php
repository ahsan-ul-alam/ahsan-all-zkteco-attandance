...
class Fingerprint
{
     ...
     */
    public static function get(AhsanAllZktecoAttandance $self, $uid)
    {
     ...
     * @return array
     */
    private function _getFinger(LaravelZkteco $self, $uid, $finger)
    {
     ...
     */
    public static function set(LaravelZkteco $self, $uid, array $data)
    {
        $self->_section = __METHOD__;
     ...
     * @return bool|mixed
     */
    private function _setFinger(LaravelZkteco $self, $data)
    {
     ...
     */
    public static function remove(LaravelZkteco $self, $uid, array $data)
    {
        $self->_section = __METHOD__;
     ...
     * @return bool
     */
    private function _removeFinger(LaravelZkteco $self, $uid, $finger)
    {
     ...
     */
    private function _checkFinger(LaravelZkteco $self, $uid, $finger)
    {
        $fingerPrint = new Fingerprint();
