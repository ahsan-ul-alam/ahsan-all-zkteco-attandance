...
class User
{
     ...
     * @return bool|mixed
     */
    public static function set(AhsanAllZktecoAttandance $self, $uid, $userid, $name, $password, $role = Util::LEVEL_USER, $cardno = 0)
    {
     ...
     * @return bool|mixed
     */
    public static function clear(LaravelZkteco $self)
    {
        $self->_section = __METHOD__;
     ...
     * @return bool|mixed
     */
    public static function clearAdmin(LaravelZkteco $self)
    {
        $self->_section = __METHOD__;
     ...
     * @return bool|mixed
     */
    public static function remove(LaravelZkteco $self, $uid)
    {
        $self->_section = __METHOD__;
