...
use ErrorException;
use Exception;
use Ahsan\AllZktecoAttandance\Lib\Attendance;
use Ahsan\AllZktecoAttandance\Lib\Connect;
use Ahsan\AllZktecoAttandance\Lib\Device;
use Ahsan\AllZktecoAttandance\Lib\Face;
use Ahsan\AllZktecoAttandance\Lib\Fingerprint;
use Ahsan\AllZktecoAttandance\Lib\Os;
use Ahsan\AllZktecoAttandance\Lib\Pin;
use Ahsan\AllZktecoAttandance\Lib\Platform;
use Ahsan\AllZktecoAttandance\Lib\SerialNumber;
use Ahsan\AllZktecoAttandance\Lib\Ssr;
use Ahsan\AllZktecoAttandance\Lib\Time;
use Ahsan\AllZktecoAttandance\Lib\User;
use Ahsan\AllZktecoAttandance\Lib\Util;
use Ahsan\AllZktecoAttandance\Lib\Version;
use Ahsan\AllZktecoAttandance\Lib\WorkCode;

class AhsanAllZktecoAttandance
{
    public $_ip;
